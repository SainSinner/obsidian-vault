...
Число 33 – целое число, число 3.53.5 – вещественное число, 'Beegeek' – строка и так далее.
...
###### **Таблицы истинности** для логических операторов `and`, `or`, `not`:
![[Pasted image 20251105193210.png]]
###### Методы списка list()
